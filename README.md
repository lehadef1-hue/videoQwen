...
| Проход | Кадры | Цель |
|--------|-------|------|
| 1a | первая половина, 25 кадров | ориентация + описание + теги + студия |
| 1b | вторая половина, 25 кадров | дополнительные теги |
| 2a | первая половина, 25 кадров | scoring кадров (1–10) |
| 2b | вторая половина, 25 кадров | scoring кадров (1–10) |

...
| Проход | Входные данные | Цель |
|--------|---------------|------|
| Pass 1 | 20 кадров равномерно по всему видео | описание, ориентация, водяные знаки, ключевые сцены |
| Pass 2 | те же 25 кадров | категории (~169 шт.) на основе визуала |
| Pass SEO | текст Pass 1 + категории | title, meta description, теги |
